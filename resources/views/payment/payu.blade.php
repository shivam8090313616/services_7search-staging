...
<form action="<?php echo $action; ?>" method="post" name="payuForm">
  ...
  <input type="hidden" name="txnid" value="<?php echo $txnid ?>" />
    ...
    <input type="hidden" name="surl" value="https://services.7searchppc.in/payment/response" size="64" />
    <input type="hidden" name="furl" value="https://services.7searchppc.in/payment/response" size="64" />

    <!-- <input type="hidden" name="surl" value="https://admintest.7searchppc.com/payment/response" size="64" />
    <input type="hidden" name="furl" value="https://admintest.7searchppc.com/payment/response" size="64" /> -->
