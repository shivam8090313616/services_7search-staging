...
class AuthController extends Controller
{
    ...
    {
        $verified = User::select('ac_verified')->where('uid', $userId)->first();
        
        // Check if the account is already verified
        if ($verified->ac_verified == 1) {
            return response()->json(['message' => 'This link has been expired!'], 403);
        }

        // Proceed with verification (you may call a service method here to handle this)
        // ...
