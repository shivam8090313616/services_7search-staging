...
class AccVerifiedService
{
    ...
    protected function sendVerificationEmail(User $user): array
    {
        try {
            ...
            $body = View::make('emailtemp.template.user_verify_mail', $mailData)->render();
    ...
    protected function sendMailUser($subject, $body, $email): array
    {
        ...
        try {
            ...
            $mail->Port = 587;
            $mail->Username = env('MAIL_USERNAME'); // Use your SMTP username from .env
            $mail->Password = env('MAIL_PASSWORD'); // Use your SMTP password from .env
            $mail->setFrom(env('MAIL_FROM_ADDRESS'), '7SearchPPC');
