           ...
           <table  style="width:100%; border-collapse: collapse;" border="0">
             ...
             <tbody>
               <tr>
                 ...
                 <td style="padding: 10px 15px;line-height: 1.55em;caption-side: bottom;border-collapse: collapse;border-top: 1px solid #dbdfea;color: #666;">${{ number_format($details['amount'], 2, '.', ',') }}</td>
               </tr>
              <tr>
                <td colspan="2"></td>
                ...
                <td style="padding: 10px 15px;line-height: 1.55em;caption-side: bottom;border-collapse: collapse;border-top: 1px solid #dbdfea;color: #666;background:#f5f6fa;">${{ number_format($details['fee'], 2, '.', ',') }}</td>
              </tr>
                <tr>
                <td colspan="2"></td>
                <td style="padding: 10px 15px;line-height: 1.55em;caption-side: bottom;border-collapse: collapse;border-top: 1px solid #dbdfea;color: #111;background:#f5f6fa;font-weight: 400;">Subtotal</td>
                <td style="padding: 10px 15px;line-height: 1.55em;caption-side: bottom;border-collapse: collapse;border-top: 1px solid #dbdfea;color: #111;background:#f5f6fa;font-weight: 400;">${{ number_format($details['subtotal'], 2, '.', ',') }}</td>
              </tr>
              <tr>
                <td colspan="2"></td>
                ...
                <td style="padding: 10px 15px;line-height: 1.55em;caption-side: bottom;border-collapse: collapse;border-top: 1px solid #dbdfea;color: #666;background:#f5f6fa;">${{ number_format($details['gst'], 2, '.', ',') }}</td>
              </tr>
              <tr>
                <td colspan="2"></td>
                ...
                <td style="padding: 10px 15px;line-height: 1.55em;caption-side: bottom;border-collapse: collapse;border-top: 1px solid #dbdfea;color: #fff;font-weight: 700; background-color: #3B82F6;">${{ number_format($details['payble_amt'], 2, '.', ',') }}</td>
              </tr>
