    ...
    protected function sendMailUser($subject, $body, $email): array
{
    ...
    try {
        // Set up SMTP and send the email using direct values
        $mail->isSMTP();
        $mail->CharSet = 'UTF-8';
        $mail->Host = 'smtp.gmail.com'; // Directly using SMTP host
        $mail->SMTPAuth = true;
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
        $mail->Port = 587; // Directly using SMTP port
        $mail->Username = 'adnan.logelite@gmail.com'; // Directly using SMTP username
        $mail->Password = 'owdwgrcdwcrlissi'; // Directly using SMTP password (use app-specific password if using 2FA)
        $mail->setFrom('adnan.logelite@gmail.com', '7SearchPPC'); // Directly using from address and name
