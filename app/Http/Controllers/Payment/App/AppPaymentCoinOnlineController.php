...
class AppPaymentCoinOnlineController extends Controller
{
    public function bitcoin_online(Request $request)
    {
        ...
        if (empty($users)) {
            ...
            $data['txnid'] =  $txnid;
            $data['amounts'] =  $amt;
            $data['res_url'] = ($request->request_for == 'App') ? 'https://services.7searchppc.in/app_payment_bitcoin_online_response' : 'https://services.7searchppc.com/app_payment_bitcoin_online_response';
