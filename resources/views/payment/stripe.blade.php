...
$stripe = new \Stripe\StripeClient($key);
  $checkout_session = $stripe->checkout->sessions->create([
    ...
    'mode' => 'payment',
    'success_url' => "https://services.7searchppc.in/stripe/response/{CHECKOUT_SESSION_ID}",
    'cancel_url' => "https://services.7searchppc.in/stripe/response/{CHECKOUT_SESSION_ID}",
  ]);
